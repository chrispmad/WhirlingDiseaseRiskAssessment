...
Note: Only hydrological networks with 100 or more streams are shown in this map, and very small streams of stream order 1 and 2 are not shown on this map; however, the connectivity analysis included all streams / rivers / lakes in B.C.
...
### Invasive Mussel Defence Program Boat Inspections {.tabset}

Map details:

-   Inspection data span 2015 to present.
