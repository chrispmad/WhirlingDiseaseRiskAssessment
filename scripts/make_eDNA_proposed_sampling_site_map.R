# Title: Make Map of eDNA proposed sampling sites
#
# Date: 2024-06-12
#
# Author(s): Chris Madsen (chris.madsen@gov.bc.ca)
#
# Description: This script takes some data that Trevor Davies
# sent me to make a map of proposed eDNA sampling sites, with
...
data.frame(y = 49.335574, x = -117.664839) |>
  sf::st_as_sf(coords = c('x','y'), crs = 4326) |>
  sf::st_transform(2955)
library(leaflet)
leaflet() |>
  addTiles() |>
