...
This script produces a static map and an interactive map of Whirling Disease sampling results, as of 2024-12-05 (December 5th). This document was produced on `r format(Sys.Date(),"%B %d, %Y")`.
...
# Join on Martina's results excel file.
...
ggsave(filename = paste0("J:/2 SCIENCE - Invasives/SPECIES/Whirling Disease/Whirling_Disease_Sampling_Results_2024_12_05.jpg"),
       plot = inset_map +
  inset_element(p = zoomed_out_map,
                left = 0.7, right = 0.975,
                top = 0.95, bottom = 0.7),
